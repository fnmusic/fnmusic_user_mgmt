...
import com.fnmusic.base.models.Error;
import com.fnmusic.base.models.ServiceResponse;
...
public class ApiControllerAdvice {
    ...
    private static Logger logger = LoggerFactory.getLogger(ApiControllerAdvice.class);
    ...
    @ResponseStatus(HttpStatus.INTERNAL_SERVER_ERROR)
    @ResponseBody
    public ServiceResponse nulPointerException(NullPointerException e) {
        ServiceResponse response = new ServiceResponse();
        response.setCode("500");
